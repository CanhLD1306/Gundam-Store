    ...
    public class BannersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Banners != null ? 
                          ...
                          Problem("Entity set 'GundamStoreDBContext.Banners'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Image,CreateAt,CreateBy,UpdateAt,UpdateBy,DeleteFlag")] Banner banner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Image,CreateAt,CreateBy,UpdateAt,UpdateBy,DeleteFlag")] Banner banner)
        {
            if (id != banner.Id)
            {
                return NotFound();
